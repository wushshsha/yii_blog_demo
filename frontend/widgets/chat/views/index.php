    ...
    <div class="panel-body">
        <form action="/" id="w0" method="post" >
            <div class="form-group input-group field-feed-content required">
                ...
                <span class="input-group-btn">
                    <button type="button" data-url="<?=Url::to(['site/add-feed'])?>" class="btn btn-success btn-feed j-feed" >发表</button>
                </span> 
            </div>
        </form>
        ...
        <ul class="media-list media-feed feed-index ps-container ps-active-y">
            ...
            <li class="media">
                ...
                <img alt="" class="avatar-img"  src="statics/images/avatar/small.jpg"/></a></div>
